    ...
    <main className="bg-background text-foreground">
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pb-8 pt-10 md:pt-16">
        ...
        <h1 className="mx-auto mt-6 max-w-4xl text-balance text-center text-4xl font-semibold leading-tight md:text-6xl">
          <span className="italic font-normal">Discover</span> <span className="font-extrabold">the correct</span>{" "}
          <span className="italic font-normal">way to</span> use your iPhone camera
        </h1>

        <p className="mx-auto mt-4 max-w-2xl text-center text-muted-foreground">
          In this step-by-step course, follow the exact settings and techniques to capture amazing photos with your
      ...
      <section className="mx-auto w-full max-w-6xl px-4 py-16">
        <h2 className="mb-10 text-center text-3xl font-semibold md:text-4xl">What you'll master.</h2>
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <Feature
            ...
            desc="Use easy tricks to frame your shots like a pro, making every picture look great."
          />
          <Feature
      ...
      <section className="mx-auto grid w-full max-w-6xl grid-cols-1 items-start gap-10 px-4 py-10 md:grid-cols-2 md:py-16">
        ...
        <div>
          ...
          <ul className="mt-6 space-y-5 text-muted-foreground">
            ...
            <li>
              <strong className="text-foreground">Go at Your Own Pace</strong>
              <br />
              Enjoy lifetime access so you can revisit whenever it's convenient for you.
            </li>
          </ul>
        </div>
      </section>
          ...
          <div className="mx-auto max-w-3xl">
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="q2">
                ...
                <AccordionContent>
                  Step-by-step lessons, presets, and lifetime access so you can revisit at your own pace.
                </AccordionContent>
              </AccordionItem>
